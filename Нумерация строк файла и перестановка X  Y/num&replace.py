'''version 16.05.2017. Нумеруем строки файла и меняем  X  и Y при необходимости.
 Пересчет координат из системы в систему - реализовать позже в общем приложении.
 Свести вместе иъятие координат, пересчет, перестановку, нумерацию. 
 Вспомогательные материалы в одном месте:
 https://gis-lab.info/qa/wgs84-sk42-wgs84-formula.html
 http://codemonkeydeveloper.blogspot.com/2015/07/pulkovo1942-wgs84.html'''
...
for i in f:
    '''разбиваем по определенному разделителю, склеиваем по введенному'''
